...
<#
.SYNOPSIS
    Creates the Azure AD app registration for this MAUI Blazor Hybrid sample using Microsoft Graph PowerShell.
...
.PARAMETER AppName
    Optional. The app registration display name. Defaults to "ciam-dotnet-blazor-maui".
...
param(
    ...
    [Parameter(Mandatory = $false)]
    [string] $AppName = "ciam-dotnet-blazor-maui",
